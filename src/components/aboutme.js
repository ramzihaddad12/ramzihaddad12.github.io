        ...
        return(
            <div style = {{marginTop: '-25px',paddingTop: '-5px', height: '100%', backgroundColor: 'lightgray'}}>
                <div style ={{fontFamily: 'monospace'}}>
                    ...
                    <p style = {{fontSize: '25px', paddingLeft: '5em', paddingBottom: '10%', paddingRight: '2em', lineHeight: '1'}}>   
                    ...
                    <ul style = {{fontSize: '25px', paddingLeft: '5em', paddingRight: '2em', lineHeight: '1'}}>
                    ...
                    The favorites: 
                    <ul style = {{fontSize: '25px', paddingLeft: '5em', paddingRight: '2em', lineHeight: '1'}}>
                    <li>Favorite number: 1729, the smallest positive number that is the sum of 2 cubes in 2 different ways: (9, 10) and (1, 12). This number, referred to as a taxicab number, has a fascinating <a href = "https://mathworld.wolfram.com/Hardy-RamanujanNumber.html">story</a> involving the mathematics legend that is Ramanujan.</li>
                    <br/>
                    ...
                    <br/>
                    <li>Favorite algorithm: PageRank. I have a deep appreciation for the simplicity and elegance of this ranking <a href = "https://en.wikipedia.org/wiki/PageRank">algorithm</a> that built the foundations of Google.</li>
                    <br/>
